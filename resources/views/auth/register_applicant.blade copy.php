      ...
      <div class="min-h-screen flex fle-col items-center justify-center p-6">
        <div class="grid lg:grid-cols-2 items-center gap-6 max-w-6xl max-lg:max-w-lg w-full">
          <form class="lg:max-w-md w-full">
            ...
            <p class="text-sm text-gray-800 mt-6">Already have an account? <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
          </form>
